...
public final class ThisWeekPricingRules {
    ...
    public static PricingRules create() {
        return new PricingRules(
                List.of(
                        Product.builder().id("A").name("A").price(BigDecimal.valueOf(50)).build(),
                        Product.builder().id("B").name("B").price(BigDecimal.valueOf(75)).build(),
                        Product.builder().id("C").name("C").price(BigDecimal.valueOf(25)).build(),
                        Product.builder().id("D").name("D").price(BigDecimal.valueOf(150)).build(),
                        Product.builder().id("E").name("E").price(BigDecimal.valueOf(200)).build()),
                List.of(
